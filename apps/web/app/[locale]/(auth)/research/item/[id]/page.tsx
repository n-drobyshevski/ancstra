...
async function ResearchItemContent({ params }: { params: Promise<{ id: string }> }) {
  ...
  return (
    <PagePadding>
      <div style={{ viewTransitionName: `research-${id}` }}>
        <ItemDetailShell item={item} />
      </div>
    </PagePadding>
  );
}
...
export default function ResearchItemPage({
  ...
  return (
    <Suspense fallback={null}>
      <ResearchItemContent params={params} />
    </Suspense>
  );
}
